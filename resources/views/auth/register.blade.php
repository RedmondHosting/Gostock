        ...
        <div class="row">
          ...
          <div class="col-sm-6 login-section-wrapper">
            <a href="{{ url('/') }}" class="mb-4 mb-lg-0 logo-login">
              <img src="{{ url('img', $settings->logo) }}" alt="logo" width="150">
            </a>
                    ...
                    @if ($settings->twitter_login == 'on')
                      ...
                      @if ($settings->google_login == 'on')
                        <div class="w-100 d-block position-relative mb-2">
                            ...
                            <img src="{{ url('img/google.svg') }}" class="me-1" width="18" height="18" /> <span class="d-none d-lg-inline-block">Google</span>
                          </a>
              					</div>
                      @endif
