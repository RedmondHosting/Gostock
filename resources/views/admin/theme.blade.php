	...
	<div class="row">
      ...
      <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <div class="row mb-3">
		          ...
		          <div class="col-lg-5 col-sm-10">
                <div class="d-block mb-2">
                  <img src="{{url('/img', $settings->logo_light)}}" class="bg-secondary" style="width:150px">
                </div>
            ...
            <div class="row mb-3">
		          ...
		          <div class="col-lg-5 col-sm-10">
                <div class="d-block mb-2">
                  <img src="{{url('/img', $settings->img_section)}}" style="width:200px">
                </div>
            ...
            <div class="row mb-3">
		          ...
		          <div class="col-lg-5 col-sm-10">
                <div class="d-block mb-2">
                  <img src="{{url('/img', $settings->watermark)}}" class="bg-secondary" style="width:300px">
                </div>
